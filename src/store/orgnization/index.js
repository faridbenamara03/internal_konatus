...
export default {
  ...
  mutations: {
    ...
    GET_UNIT_REPORTING_DATA(state, data) {
      state.unitReportingData.push(data)
    },
  ...
  actions: {
    get_unit_reporting_data() {
      axios.get('https://api.konatus.site/v1/api/unit/reporting').then(response => {
    ...
    get_unit_demand_data() {
      axios.get('https://api.konatus.site/v1/api/unit/demand').then(response => {
    ...
    get_unit_control_data() {
      axios.get('https://api.konatus.site/v1/api/unit/control').then(response => {
