<template>
  <div style="width:100%;" class="m-1" >
    <div class="mb-3" style="position: relative">
      <div v-for="(team, index) in data_source" :key="index" style="position:relative">
        ...
        <div class="containerSelf mb-2">
          <div class="rounded-left"
            ...
            <div v-for="(item, index) in team.series" :key="index" :style="`display: ${collapsed ? 'none' : 'block'}`" class="pr-1 pl-1">
          ...
          <div style="width:calc(100% - 350px)">
            ...
            <template v-for="(item, index) in team.series" >
        ...
        <div class="containerSelf mb-2">
          ...
          <div style="width:calc(100% - 350px);font-weight:bold;" class="d-flex">
            <template v-for="(item, index) in team.teamCapacity">
...
export default {
  ...
  methods: {
    ...
    setOffset() {
      ...
      this.sWidth = 348 + 17 + (cwidth - 28 - 350) / 3.5
  ...
  data() {
    return {
      ...
      data_source: this.$store.state.orgnizationState.unitControlData,
      sWidth: 0,
      bndWidth: 0,
      collapsed: false
    }
