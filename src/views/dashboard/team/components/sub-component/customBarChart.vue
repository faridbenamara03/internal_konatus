  ...
  <div class="p-2">
      ...
      <div style="width:calc(100% - 40px);">
        <div
          ...
          <div v-for="(t, i) in xAxisData" :key="i" class="d-flex flex-column justify-content-end"
            ...
            <div v-for="(t1, i1) in skillsetArr" class="tool-tip" @click="onSubClick(chartData[i][i1].skillset)" :style="`height:${chartData[i][i1].engaged / yAxisData[0] * 260}px;cursor:pointer;width:100%;background:${genBgColor(chartData[i][i1].engaged, chartData[i][i1].extCap)}${selectedSkillset !== null && selectedSkillset !== chartData[i][i1].skillset ? '44' : 'ff'};
    ...
    <div class="mt-4 w-100">
      ...
      <div class="containerSelf">
        ...
        <div class="containerSelf p-0" style="width: calc(100% - 250px);">
          <div class="sub-main" v-for="(item, i1) in labelData" :key="i1" style="padding-top:5px; padding-bottom: 5px;font-size:13px;min-width:130px;">
            {{ item }}
          </div>
        </div>
      </div>
