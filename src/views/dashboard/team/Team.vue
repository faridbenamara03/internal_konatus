...
export default {
  ...
  computed: {
    ...
    teamId() {
      return this.$store.state.teamState.teamDemandData[0].id
    },
    dataType() {
      return this.$store.state.teamState.teamDemandData[0].type
    }
  },
  mounted() {
  ...
  methods: {
    ...
    handleManage() {
      this.isManageView = !this.isManageView
      console.log("affiche valeur de test", this.isManageView)
      console.log("team Id", this.$store.state.teamState.teamDemandData[0].id)
      console.log("affiche moi le tout", this.$store.state.teamState.teamDemandData[0].type)
      console.log("affiche moi le tout", this.$store.state)
      },
  }
}
</script>
