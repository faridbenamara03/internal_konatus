          ...
          <div>
            ...
            <div v-if="tabIndex === 1">
              ...
              <b-button
                ...
                class="ml-1"
                variant="primary"
                @click="runPythonScript5"
              >
                <feather-icon
                  icon="RotateCwIcon"
                  size="16"
                />&nbsp;
                <span>Update Ext</span>
              </b-button>
              <b-button
                v-if="!reportingTableEditable"
                class="ml-1"
                variant="primary"
                @click="runPythonScript4"
              >
                <feather-icon
                  icon="UploadIcon"
                  size="16"
            ...
            <div v-if="(tabIndex === 2)">
              ...
              <b-button
                ...
                variant="primary"
                class="ml-1"
                @click="runPythonScript3"
              >
                <feather-icon
                  icon="ArrowDownIcon"
                  size="16"
                />&nbsp;
                <span>Update & Synch Jira</span>
              </b-button>
              <b-button
                v-b-modal.modal-edit-column
                class="ml-1"
